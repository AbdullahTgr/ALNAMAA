...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="form-group">
                        ...
                        <input id="inputTitle-ar" type="text" name="title-ar" placeholder="اسم المنتج"  value="<?php echo e(old('title-ar')); ?>" class="form-control">
                        <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<div class="form-group">
  ...
  <input id="inputTitle-fr" type="text" name="title-fr" placeholder="اسم المنتج"  value="<?php echo e(old('title-fr')); ?>" class="form-control">
  <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alnamaastore\resources\views/backend/product/create.blade.php ENDPATH**/ ?>