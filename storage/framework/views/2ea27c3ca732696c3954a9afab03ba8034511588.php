  ...
  <li class="nav-item">
    ...
    <div id="postCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="<?php echo e(route('post_m.index')); ?>">Posts</a>
        <a class="collapse-item" href="<?php echo e(route('post_m.create')); ?>">Add Post</a> 
      </div>
    </div>
  </li>
...
</ul><?php /**PATH C:\xampp\htdocs\alnama_store\resources\views/backend/layouts/sidebar_m.blade.php ENDPATH**/ ?>