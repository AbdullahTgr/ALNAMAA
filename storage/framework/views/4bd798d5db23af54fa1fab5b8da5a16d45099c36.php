...
<?php $__env->startSection('meta'); ?>
	...
	<meta name="description" content="<?php echo strip_tags( $post->{'quote-ar'} ); ?>">
	
    
	<meta property="og:type" content="article">
	<meta property="og:title" content="<?php echo strip_tags($post->{'title-ar'}); ?>">
	<meta property="og:image" content="<?php echo e($post->photo); ?> ">
	<meta property="og:description" content="<?php echo strip_tags($post->{'description-ar'} ); ?>">
<?php $__env->stopSection(); ?>


<?php $__env->startSection('title',strip_tags($post->{'title-ar'})); ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">  
                                    <h2 class="blog-title"><?php echo e($post->{'title-ar'}); ?></h2>
                                    <div class="blog-meta">
                                    ...
                                    <div class="content">
                                        <?php if($post->{'quote-ar'}): ?>
                                        <blockquote> <i class="fa fa-quote-left"></i> <?php echo ($post->{'quote-ar'}); ?> </blockquote>
                                        <?php endif; ?> 
                                        <p><?php echo ($post->{'description-ar'}); ?></p>
                                    </div>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u953809391/domains/al-namapacking.com/public_html/new/resources/views/frontend/pages/blog-detail.blade.php ENDPATH**/ ?>