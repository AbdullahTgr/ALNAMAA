<?php $__env->startSection('title',config('app.nameeng')); ?>
...
<input id="inputTitle-ar" type="text" name="title-ar" placeholder="العنوان علي البانر"  value="<?php echo e(old('title-ar')); ?>" class="form-control">
...
<input id="inputTitle-fr" type="text" name="title-fr" placeholder="العنوان بالفرنسية علي البانر"  value="<?php echo e(old('title-fr')); ?>" class="form-control">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u953809391/domains/al-namapacking.com/public_html/new/resources/views/backend/banner/create.blade.php ENDPATH**/ ?>