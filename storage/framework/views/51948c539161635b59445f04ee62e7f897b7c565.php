                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                ...
                                <form method="POST" action="<?php echo e(route('subscribe')); ?>" class="form-inner">
                                    ...
                                    <button type="submit" class="btn " style="width: 100%"><?php echo e(Lang::get('msg.submit')); ?></button>
                                </form>
                            </div>
                        </div>
                        <!--/ End Single Widget -->
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alnamaastore\resources\views/frontend/pages/blog.blade.php ENDPATH**/ ?>