				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="javascript:void(0);"><?php echo e(Lang::get('msg.wishlist')); ?></a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								...
								<th class="text-center"><?php echo e(Lang::get('msg.addtocart')); ?></th> 
							...
							<?php if(Helper::getAllProductFromWishlist()): ?>
								<?php $__currentLoopData = Helper::getAllProductFromWishlist(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$wishlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										...
										<td><a href="<?php echo e(route('add-to-cart',$wishlist->product['slug'])); ?>" class='btn text-white'><?php echo e(Lang::get('msg.addtocart')); ?></a></td>
							...
							<?php else: ?> 
								<tr>
									<td class="text-center">
										<?php echo e(Lang::get('msg.therearenowishlistavaliable')); ?> <a href="<?php echo e(route('product-grids')); ?>" style="color:blue;"><?php echo e(Lang::get('msg.continueshopping')); ?></a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alnamaastore\resources\views/frontend/pages/wishlist.blade.php ENDPATH**/ ?>