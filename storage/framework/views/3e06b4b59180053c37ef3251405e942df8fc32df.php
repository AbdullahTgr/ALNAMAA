...
<?php $__env->startSection('title','Span || Brand Create'); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <input id="inputTitle-ar" type="text" name="title-ar" placeholder="اسم البراند"  value="<?php echo e(old('title-ar')); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
        ...
        <input id="inputTitle-fr" type="text" name="title-fr" placeholder="اسم البراند بالفرنسي"  value="<?php echo e(old('title-fr')); ?>" class="form-control">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\spanshop\resources\views/backend/brand/create.blade.php ENDPATH**/ ?>