...
unset($__errorArgs, $__bag); ?>
          ...
          <input id="inputTitle-ar" type="text" name="title-ar" placeholder="العنوان"  value="<?php echo e($category->{'title-ar'}); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
          ...
          <input id="inputTitle-fr" type="text" name="title-fr" placeholder="العنوان"  value="<?php echo e($category->{'title-fr'}); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
          ...
          <textarea class="form-control" id="summary-ar" name="summary-ar"><?php echo e($category->{'summary-ar'}); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
          ...
          <textarea class="form-control" id="summary-fr" name="summary-fr"><?php echo e($category->{'summary-fr'}); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u953809391/domains/al-namapacking.com/public_html/new/resources/views/backend/category/edit.blade.php ENDPATH**/ ?>