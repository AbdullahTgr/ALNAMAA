                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="blog-single.html"><?php echo e(Lang::get('msg.shopgrid')); ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        ...
                        <div class="row">
                            ...
                            <?php if(count($products)>0): ?>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="single-product">
                                            <div class="product-img">
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        ...
                                                        <a title="Wishlist" href="<?php echo e(route('add-to-wishlist',$product->slug)); ?>" class="wishlist" data-id="<?php echo e($product->id); ?>"><i class=" ti-heart "></i><span><?php echo e(Lang::get('msg.addtowishlist')); ?></span></a>
                                                    </div>
                                            ...
                                            <div class="product-content">
                                                <h3><a href="<?php echo e(route('product-detail',$product->slug)); ?>"><?php echo e($product->{'title-ar'}); ?></a></h3>
                                                <?php
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                                    <h4 class="text-warning" style="margin:100px auto;"><?php echo e(Lang::get('msg.therearenoproducts')); ?></h4>
                            <?php endif; ?>
                                        ...
                                        <div class="quickview-content">
                                            ...
                                            <div class="quickview-ratting-review">
                                                ...
                                                <div class="quickview-stock">
                                                    ...
                                                    <?php else: ?> 
                                                    <span><i class="fa fa-times-circle-o text-danger"></i> <?php echo e($product->stock); ?> </span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <?php
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u953809391/domains/al-namapacking.com/public_html/new/resources/views/frontend/pages/product-grids.blade.php ENDPATH**/ ?>