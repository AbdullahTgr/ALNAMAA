...
<div class="card">
    ...
    <div class="card-body">
      ...
      <form method="post" action="<?php echo e(route('post.store')); ?>"> 
        ...
        <?php else: ?>   
        <form method="post" action="<?php echo e(route('post_m.store')); ?>"> 
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input id="inputTitle-ar" type="text" name="title-ar" placeholder="عنوان المنشور"  value="<?php echo e(old('title-ar')); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="quote-ar" name="quote-ar"><?php echo e(old('quote-ar')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="description-ar" name="description-ar"><?php echo e(old('description-ar')); ?></textarea>
...
<div class="col-xs-12 " style="background:#ddd">
  ...
  <div class="form-group">
    ...
    <input id="inputTitle-fr" type="text" name="title-fr" placeholder="عنوان المنشور"  value="<?php echo e(old('title-fr')); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="quote-fr" name="quote-fr"><?php echo e(old('quote-fr')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="description-fr" name="description-fr"><?php echo e(old('description-fr')); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alnama_store\resources\views/backend/post/create.blade.php ENDPATH**/ ?>