...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input id="inputTitle-ar" type="text" name="title-ar" placeholder="ادخل اسم المنتج"  value="<?php echo e($product->{'title-ar'}); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="summary-ar" name="summary-ar"><?php echo e($product->{'summary-ar'}); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="description-ar" name="description-ar"><?php echo e($product->{'description-ar'}); ?></textarea>
...
<div class="col-xs-12 " style="background:#ddd">
  ...
  <div class="form-group">
    ...
    <input id="inputTitle-fr" type="text" name="title-fr" placeholder="ادخل اسم المنتج بالفرنسي"  value="<?php echo e($product->{'title-fr'}); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="summary-fr" name="summary-fr"><?php echo e($product->{'summary-fr'}); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="description-fr" name="description-fr"><?php echo e($product->{'description-fr'}); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u953809391/domains/al-namapacking.com/public_html/new/resources/views/backend/product/edit.blade.php ENDPATH**/ ?>