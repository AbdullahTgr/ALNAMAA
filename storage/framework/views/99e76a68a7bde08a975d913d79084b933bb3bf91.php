			...
			<div class="row">
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							<li><a href="<?php echo e(('home')); ?>"><?php echo e(Lang::get('msg.home')); ?><i class="ti-arrow-right"></i></a></li>
							<li class="active"><a href=""><?php echo e(Lang::get('msg.cart')); ?></a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								<th><?php echo e(Lang::get('msg.product')); ?></th>
								<th><?php echo e(Lang::get('msg.name')); ?></th>
								<th class="text-center"><?php echo e(Lang::get('msg.unitprice')); ?></th>
								<th class="text-center"><?php echo e(Lang::get('msg.quantity')); ?></th>
								<th class="text-center"><?php echo e(Lang::get('msg.total')); ?></th> 
								...
								<?php if(Helper::getAllProductFromCart()): ?>
									<?php $__currentLoopData = Helper::getAllProductFromCart(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
											...
											<td class="product-des" data-title="Description">
												<p class="product-name"><a href="<?php echo e(route('product-detail',$cart->product['slug'])); ?>" target="_blank"><?php echo e($cart->product['title-ar']); ?></a></p>
									...
									<track>
										...
										<td class="float-right">
											<button class="btn float-right" type="submit"><?php echo e(Lang::get('msg.update')); ?></button>
										</td>
									</track>
								<?php else: ?> 
										<tr>
											<td class="text-center">
												<?php echo e(Lang::get('msg.therearenocartsavaliable')); ?><a href="<?php echo e(route('product-grids')); ?>" style="color:blue;"><?php echo e(Lang::get('msg.continueshopping')); ?></a>
					...
					<div class="total-amount">
						<div class="row">
							<div class="col-lg-8 col-md-5 col-12">
								<div class="left">
									...
									<form action="<?php echo e(route('coupon-store')); ?>" method="POST">
											<?php echo csrf_field(); ?>
											<input name="code" placeholder="<?php echo e(Lang::get('msg.enteryourcopon')); ?>">
											<button class="btn"><?php echo e(Lang::get('msg.apply')); ?></button>
										</form>
									</div>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="<?php echo e(Helper::totalCartPrice()); ?>"><?php echo e(Lang::get('msg.cartsubtotal')); ?><span>$<?php echo e(number_format(Helper::totalCartPrice(),2)); ?></span></li>
										
										 
										<?php if(session()->has('coupon')): ?>
										<li class="coupon_price" data-price="<?php echo e(Session::get('coupon')['value']); ?>"><?php echo e(Lang::get('msg.yousave')); ?><span>$<?php echo e(number_format(Session::get('coupon')['value'],2)); ?></span></li>
										<?php endif; ?>
										<?php
									...
									<div class="button5">
										<a href="<?php echo e(route('checkout')); ?>" class="btn"><?php echo e(Lang::get('msg.checkout')); ?></a>
										<a href="<?php echo e(route('product-grids')); ?>" class="btn"><?php echo e(Lang::get('msg.continueshopping')); ?></a>
									</div>
								</div>
							</div>
						</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u953809391/domains/al-namapacking.com/public_html/new/resources/views/frontend/pages/cart.blade.php ENDPATH**/ ?>