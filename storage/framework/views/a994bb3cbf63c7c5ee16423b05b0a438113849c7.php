				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="blog-single.html"><?php echo Lang::get('msg.aboutus'); ?></a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-6 col-12">
						<div class="about-content">
							...
							?>
							<h3><?php echo e(Lang::get('msg.subscribeto')); ?><?php echo Lang::get('msg.welcometo'); ?>  <span> </span></h3>
					...
					<div class="col-lg-6 col-12">
						<div class="about-img overlay">
							<div class="button">
								<a href="https://www.youtube.com/watch?v=irWA_4F0CeQ" class="video video-popup mfp-iframe"><i class="fa fa-play"></i></a>
							</div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u953809391/domains/al-namapacking.com/public_html/new/resources/views/frontend/pages/about-us.blade.php ENDPATH**/ ?>