                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);"><?php echo e(Lang::get('msg.register')); ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row"> 
                <div class="col-lg-6 offset-lg-3 col-12">
                    <div class="login-form">
                        <h2><?php echo e(Lang::get('msg.register')); ?></h2>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label><?php echo e(Lang::get('msg.confirmpassword')); ?><span>*</span></label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    <div class="form-group login-btn">
                                        <button class="btn" type="submit"><?php echo e(Lang::get('msg.register')); ?></button>
                                        <a href="<?php echo e(route('login.form')); ?>" class="btn"><?php echo e(Lang::get('msg.login')); ?></a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alnama_store\resources\views/frontend/pages/register.blade.php ENDPATH**/ ?>