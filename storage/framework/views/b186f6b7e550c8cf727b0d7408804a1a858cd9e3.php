      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; <a href="https://www.facebook.com/spansoftware" target="_blank"><?php echo e(Lang::get('msg.Alsaidi')); ?></a> 2022</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  </script><?php /**PATH C:\xampp\htdocs\alnama_store\resources\views/backend/layouts/footer.blade.php ENDPATH**/ ?>