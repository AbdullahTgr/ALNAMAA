                        ...
                        <div class="single-widget recent-post">
                            ...
                            <?php $__currentLoopData = $recent_posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="single-post">
                                    ...
                                    <div class="content">
                                        <h5><a href="#"><?php echo e($post->{'title-ar'}); ?></a></h5>
                                        <ul class="comment">
                                        <?php 
                        ...
                        <div class="single-widget side-tags">
                            ...
                            <ul class="tag">
                                <?php $__currentLoopData = Helper::postTagList('posts'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href=""><?php echo e($tag->{'title-ar'}); ?></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                        <!--/ End Single Widget -->
                            ...
                            <div class="letter-inner">
                                ...
                                <form action="<?php echo e(route('subscribe')); ?>" method="POST">
                                    ...
                                    <div class="form-inner">
                                        <input type="email" name="email" placeholder="<?php echo e(Lang::get('msg.youremail')); ?>">
                                        <button type="submit" class="btn mt-2"><?php echo e(Lang::get('msg.submit')); ?> </button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\alnamaastore\resources\views/frontend/pages/blog-detail.blade.php ENDPATH**/ ?>