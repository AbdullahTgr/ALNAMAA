...
<?php $__env->startSection('title','Span || Brand Edit'); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <input id="inputTitle-ar" type="text" name="title-ar" placeholder="ايم البراند"  value="<?php echo e($brand->{'title-ar'}); ?>" class="form-control">
...
<div class="col-xs-12 " style="background:#ddd">
  ...
  <input id="inputTitle-fr" type="text" name="title-fr" placeholder="اسم البراند"  value="<?php echo e($brand->{'title-fr'}); ?>" class="form-control">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\spanshop\resources\views/backend/brand/edit.blade.php ENDPATH**/ ?>