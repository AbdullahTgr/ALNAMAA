					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="javascript:void(0);"><?php echo e(Lang::get('msg.shoplist')); ?></a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-3 col-md-4 col-12">
							<div class="shop-sidebar">
                                ...
                                <div class="single-widget category">
                                    <h3 class="title"><?php echo e(Lang::get('msg.categories')); ?></h3>
										...
										<li>
											<?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<?php if($cat_info->child_cat->count()>0): ?>
														<li><a href="<?php echo e(route('product-cat',$cat_info->slug)); ?>"><?php echo e($cat_info->{'title-ar'}); ?></a>
															<ul>
																<?php $__currentLoopData = $cat_info->child_cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																	<li><a href="<?php echo e(route('product-sub-cat',[$cat_info->slug,$sub_menu->slug])); ?>"><?php echo e($sub_menu->{'title-ar'}); ?></a></li>
																<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
															</ul>
														</li>
													<?php else: ?>
														<li><a href="<?php echo e(route('product-cat',$cat_info->slug)); ?>"><?php echo e($cat_info->{'title-ar'}); ?></a></li>
													<?php endif; ?>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										</li>
										<?php endif; ?>
								...
								<div class="single-widget range">
									<h3 class="title"><?php echo e(Lang::get('msg.shopbyprice')); ?></h3>
									<div class="price-filter">
										<div class="price-filter-inner">
											...
											<button type="submit" class="filter_button"><?php echo e(Lang::get('msg.filter')); ?></button>
											<div class="label-input">
												<span><?php echo e(Lang::get('msg.range')); ?>:</span>
                                ...
                                <div class="single-widget recent-post">
                                    ...
                                    <?php $__currentLoopData = $recent_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                <h5><a href="<?php echo e(route('product-detail',$product->slug)); ?>"><?php echo e($product->{'title-ar'}); ?></a></h5>
                                                <?php
                                ...
                                <!-- Single Widget -->
                                <div class="single-widget category">
                                    <h3 class="title"><?php echo e(Lang::get('msg.brands')); ?></h3>
                                    <ul class="categor-list">
                                        <?php
                                            $brands=DB::table('brands')->orderBy('title','ASC')->where('status','active')->get();
                                        ?>
                                        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><a href="<?php echo e(route('product-brand',$brand->slug)); ?>"><?php echo e($brand->{'title-ar'}); ?></a></li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </div>
                                <!--/ End Single Widget -->
						...
						<div class="col-lg-9 col-md-8 col-12">
									...
									<div class="shop-top">
										<div class="shop-shorter">
											<div class="single-shorter">
												<label><?php echo e(Lang::get('msg.show')); ?> :</label>
												<select class="show" name="show" onchange="this.form.submit();">
													<option value=""><?php echo e(Lang::get('msg.default')); ?></option>
											...
											<div class="single-shorter">
												<label><?php echo e(Lang::get('msg.sortby')); ?> :</label>
												<select class='sortBy' name='sortBy' onchange="this.form.submit();">
													<option value=""><?php echo e(Lang::get('msg.default')); ?></option>
													<option value="title" <?php if(!empty($_GET['sortBy']) && $_GET['sortBy']=='title'): ?> selected <?php endif; ?>><?php echo e(Lang::get('msg.name')); ?></option>
													<option value="price" <?php if(!empty($_GET['sortBy']) && $_GET['sortBy']=='price'): ?> selected <?php endif; ?>><?php echo e(Lang::get('msg.price')); ?></option>
													<option value="category" <?php if(!empty($_GET['sortBy']) && $_GET['sortBy']=='category'): ?> selected <?php endif; ?>><?php echo e(Lang::get('msg.category')); ?></option>
													<option value="brand" <?php if(!empty($_GET['sortBy']) && $_GET['sortBy']=='brand'): ?> selected <?php endif; ?>><?php echo e(Lang::get('msg.brand')); ?></option>
												</select>
											</div>
										</div>
										<ul class="view-mode">
							...
							<div class="row">
								<?php if(count($products)): ?>
														...
														<div class="product-img">
															...
															<div class="button-head">
																<div class="product-action">
																	<a data-toggle="modal" data-target="#<?php echo e($product->id); ?>" title="Quick View" href="#"><i class=" ti-eye"></i><span><?php echo e(Lang::get('msg.quckshop')); ?></span></a>
																	<a title="Wishlist" href="<?php echo e(route('add-to-wishlist',$product->slug)); ?>" class="wishlist" data-id="<?php echo e($product->id); ?>"><i class=" ti-heart "></i><span><?php echo e(Lang::get('msg.addtowishlist')); ?><?php echo e(Lang::get('msg.addtowishlist')); ?></span></a>
																</div>
												...
												<div class="col-lg-8 col-md-6 col-12">
													<div class="list-content">
														<div class="product-content">
															...
															<h3 class="title"><a href="<?php echo e(route('product-detail',$product->slug)); ?>"><?php echo e($product->{'title-ar'}); ?></a></h3>
														
														</div>
														<p class="des pt-2"><?php echo html_entity_decode($product->{'summary-ar'}); ?></p>
														<a href="javascript:void(0)" class="btn cart" data-id="<?php echo e($product->id); ?>"><?php echo e(Lang::get('msg.buynow')); ?></a>
													</div>
												</div>
											</div>
										</div>
									...
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								<?php else: ?>
									<h4 class="text-warning" style="margin:100px auto;"><?php echo e(Lang::get('msg.therearenoproduct')); ?></h4>
								<?php endif; ?>
							</div>
							 <div class="row">
									...
									<div class="row no-gutters">
										...
										<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
											<div class="quickview-content">
												<h2><?php echo e($product->{'title-ar'}); ?></h2>
												...
												<div class="quickview-peragraph">
													<p><?php echo html_entity_decode($product->{'summary-ar'}); ?></p>
												</div>
												<?php if($product->size): ?>
													<div class="size">
														<h4><?php echo e(Lang::get('msg.size')); ?></h4>
														<ul>
															<?php 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u953809391/domains/al-namapacking.com/public_html/new/resources/views/frontend/pages/product-lists.blade.php ENDPATH**/ ?>